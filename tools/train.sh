...
rmpyc && cp -r models datasets util utils main.py engine.py submit_dance.py $1 $OUTPUT_DIR
echo " ...Done"
...
cleanup() {
  ...
  rmpyc
  # tar -zcf models datasets util utils main.py engine.py eval.py submit.py --remove-files
  echo " ...Done"
}
